...
# ap.add_argument('-cli', help='Runs an cli menu version.\n', action"store_true") # Developing
...
if args['tor_install']:
    ...
    while True:
        tor = input("Do you want to install Tor? | yes/no: ") # Asks if you've got Tor services installed.
...
if args['tor']:
    ...
    logo.breach_logo() # Prints the logo.
    while True:
        tor = input("Do you want to turn Tor on/off or reload? | on/off/reload: ") # Asks if you've got Tor services installed.
        print("\n") # Adds a break in the lines
        if  tor == "on":
...
if args['whois']:
    ...
    logo.breach_logo() # Prints the logo.
    while True:
        whoisrec_ip_entered = input("Please enter the ip address that you want to record grab: ") # Just asks you to give the program what IP you want to whois.
        print("\n") # Adds a break in the lines
    ...
    while True:
        ...
        for i in range(len(data)):
            ...
            try:
                ...
                print("Failed to get repo commits here on in, try again later.")
    else :
        exit()
